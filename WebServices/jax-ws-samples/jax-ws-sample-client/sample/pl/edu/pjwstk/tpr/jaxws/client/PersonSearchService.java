 ...
 * 
 */
@WebServiceClient(name = "PersonSearchService", targetNamespace = "http://search/", wsdlLocation = "http://localhost:8080/jax-ws-sample/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/jax-ws-sample/people?wsdl");
